...
| 구직자 통계 | 지원/완료/노쇼/평점 현황 |
| 이력서 완성도 | % 및 미입력 항목 안내 |
| 기업 통계 | 공고별 지원율/노쇼율/완료율/TOP5 |
...
- Rate Limit (로그인 10회/분, 회원가입 5회/분, 얼리버드 3회/분)
- 민감정보 분리 (UserPrivateResponseDto - 계좌정보 본인/ADMIN만 노출)
- Swagger 운영 환경 비활성화 설정
