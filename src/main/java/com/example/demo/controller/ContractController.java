...
public class ContractController {
    ...
    public ResponseEntity<ApiResponse<?>> getContract(@PathVariable Long contractId) {
        return ResponseEntity.ok(ApiResponse.ok(
    ...
    public ResponseEntity<ApiResponse<?>> cancelContract(@PathVariable Long contractId) {
    ...
    public ResponseEntity<ApiResponse<?>> generatePdf(@PathVariable Long contractId) {
