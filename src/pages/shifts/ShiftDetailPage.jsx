...
// ── 사이드 드로워 ────────────────────────────────────────
function SideDrawer({ applicant, index, onClose, onPin, onHire, onReject, onViewProfile, actionLoading }) {
      ...
      <div className="absolute right-0 top-0 h-full w-full sm:w-[380px] bg-white shadow-2xl flex flex-col">
        ...
        <div className="p-4 border-t border-offwhite-200 space-y-2.5">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              onClick={onHire}
              disabled={applicant.status === 'hired' || actionLoading != null}
            ...
            <button
              onClick={onReject}
              disabled={applicant.status === 'rejected' || actionLoading != null}
                        ...
                        {a.status === 'pending' ? (
                          <>
                            <button
                              ...
                              className="flex items-center gap-1 text-xs font-bold text-white bg-green-600 hover:bg-green-700 px-3 py-2 rounded-xl transition-colors min-w-[52px] justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                              <Check size={13} />채용
                            </button>
                            <button
                              ...
                              disabled={actionLoading != null}
                              className="flex items-center gap-1 text-xs font-bold text-red-500 bg-red-50 hover:bg-red-100 border border-red-200 px-3 py-2 rounded-xl transition-colors min-w-[52px] justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                              <UserX size={13} />거절
                            </button>
                          </>
